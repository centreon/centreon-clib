 ...
 *  Default constructor.
 */
command_line::command_line() : _argc(0), _argv(nullptr), _size(0) {}
 ...
 */
command_line::command_line(command_line const& right) : _argv(nullptr) {
 ...
 *  Destructor.
 */
command_line::~command_line() noexcept { _release(); }
 ...
 */
bool command_line::operator==(command_line const& right) const noexcept {
 ...
 *  @return Size.
 */
int command_line::get_argc() const noexcept { return _argc; }
 ...
 */
char** command_line::get_argv() const noexcept { return _argv; }
