...
htmlhelp_basename = 'CentreonClibdoc'
...
latex_documents = [
  ('index', 'CentreonClib.tex', u'Centreon Clib Documentation',
   u'Centreon', 'manual'),
]
...
man_pages = [
    ('index', 'centreonclib', u'Centreon Clib Documentation',
     [u'Centreon'], 1)
]
...
texinfo_documents = [
  ('index', 'CentreonClib', u'Centreon Clib Documentation',
   u'Centreon', 'CentreonClib', 'One line description of project.',
   'Miscellaneous'),
]
